 ...
 */
package rconclient.threadmanager;
...
public class ThreadManager {
    ...
    /**
     * Managed starting of threads. Beware worker thread managment uses names
     *
     * @param thread Thread that is going to be started.
     * @param type Type of thread. If the ThreadType is <b>WORKER</b> the thread will be started only if its the only thread of its type in the application, and if its ThreadType is <b>ASYNCJOB</b> then it starts anyways.
